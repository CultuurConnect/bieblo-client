...
const initialState = {
  ...
  illustrations: shuffle(
    [
      ...
      {id: 12, cls: 'new', img: 'http://previews.123rf.com/images/sentavio/sentavio1509/sentavio150900089/44797587-Laboratory-research-chemical-flat-style-design-vector-illustration--Stock-Photo.jpg', label: 'Wetenschap'},
    ]
  ).map(
    (item, idx) => ({
      ...item,
